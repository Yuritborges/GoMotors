...
export function PaymentModal({ order, onClose, onPaid }: PaymentModalProps) {
  ...
  return (
    <div
      className="fixed inset-0 z-[70] overflow-y-auto overscroll-contain bg-black/50"
      role="dialog"
      aria-modal="true"
      aria-label="Receber pagamento"
    >
      <div className="flex min-h-full items-end justify-center p-4 pb-[calc(5.5rem+env(safe-area-inset-bottom))] sm:items-center sm:pb-8">
        <Card className="w-full max-w-lg shrink-0 shadow-xl">
          <CardHeader>
